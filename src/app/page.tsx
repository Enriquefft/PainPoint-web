						...
						<div className="flex flex-col items-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
									Practice customer interviews with our AI-powered WhatsApp bot.
									Get instant feedback based on "The Mom Test" principles.
								</p>
							</div>
							<div>
							...
							<div className="space-y-4">
								...
								<ul className="grid gap-4">
									<li className="flex items-center gap-4">
										...
										<span>
											Register with just your name and target user persona
										</span>
									</li>
									<li className="flex items-center gap-4">
										<CheckCircle2 className="h-6 w-6 text-primary" />
			...
			<footer className="w-full py-6 bg-gray-100">
				<div className="container px-4 md:px-6">
					<p className="text-center text-sm text-gray-500">
						© 2024 PainPoint. All rights reserved. Based on The Mom Test by Rob
						Fitzpatrick.
					</p>
				</div>
			</footer>
