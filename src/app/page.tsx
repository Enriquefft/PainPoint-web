...
function Header() {
  return (
    <header className="w-full bg-white shadow-md py-4 top-0">
...
export default function LandingPage() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full bg-gradient-to-b from-white to-gray-100 py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="space-y-6 lg:pr-8">
              ...
              <p className="text-gray-600 md:text-lg max-w-[600px] leading-relaxed">
                You’re not alone. Many university founders find it tough
                to ask the right questions and get real insights from potential
            ...
            <Card className="relative overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-500">
                  Practice interviews right in WhatsApp. No new apps to
                  download or complex setups required.
                </p>
              </CardContent>
            </Card>
            <Card className="relative overflow-hidden hover:shadow-xl transition-shadow">
      ...
      {/* 3. How It Works */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50" id="start-practicing">
        <div className="container px-4 md:px-6">
            ...
            <div className="space-y-6">
              ...
              <ul className="grid gap-6">
                <li className="flex items-start gap-4">
                  ...
                  <span>
                    <strong>1.</strong> Register with just your name and target user persona
                  </span>
                </li>
                <li className="flex items-start gap-4">
                  <CheckCircle2 className="h-6 w-6 text-primary mt-1" />
                ...
                <li className="flex items-start gap-4">
                  <CheckCircle2 className="h-6 w-6 text-primary mt-1" />
                  <span>
                    <strong>4.</strong> Receive detailed feedback on your technique
                  </span>
                </li>
              </ul>
